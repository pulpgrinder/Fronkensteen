  ...
  (fronkensteen-top-toolbar "#fronkensteen-nav-bar"
    (<<
        ...
        (topcoat-navigation-bar-item  "#fronkensteen-page-title-wrapper" (<<
            ...
            (input "#fronkensteen-editor-page-title.topcoat-text-input!type='text'!size='20'")
            ))
...
(define (set-save-popover)
  (set-popover "#fronkensteen-page-save-button"
    (topcoat-button-bar
    (<<
      (fronkensteen-toolbar-text-button "#fronkensteen-page-save-world-button.save-button" "Save as standalone HTML web page" "Web Page")
