...
(define (#remote-eval-expression-button_touch_click)
    (let ((selection (cm-editor-get-scheme-selection-or-expr-before-cursor! "#remote-terminal-code-input")))
    (remote-evaluate selection)))

(define (#remote-eval-button_touch_click)
    (cm-editor-select-all "#remote-terminal-code-input")
    (remote-eval-expression-button_touch_click))

(define (#remote-eval-done-button_touch_click)
