(define (fronkensteen-documentation-procedure-field)
  (dv "#fronkensteen-documentation-toolbar" (<<
      (button "#fronkensteen-documentation-done-button!title='Done'" (fa-icon "s" "check"))
      (button "#fronkensteen-update-documentation-button!title='Save updated documentation'" (fa-icon "s" "save"))
      (button "#fronkensteen-export-documentation-button!title='Export documentation database'" (fa-icon "s" "file-export"))
      (button "#fronkensteen-rebuild-documentation-button!title='Rebuild documentation database'" (fa-icon "s" "database"))
        (span "&nbsp;&nbsp;Procedure name: ")
  ...
  (<<
    (dv "#fronkesteen-documentation-source-info"
      (<<
        ...
        (span "&nbsp;")
        (span "&nbsp;line:&nbsp;")
        (span "#fronkensteen-documentation-source-line-number" "") (button "#fronkensteen-edit-doc-source-file-button" "Open source file in editor")))
